// bacic types
let id: number = 5;
let myName: string = "favour";
let enchanted: boolean = true;
...
// Tupple
let person: [number, string, boolean] = [1, "favour", true]; // setting the data type in the array in this paticular order depending on the types you set
...
let strArray = getArray<string>(["bola", "favour", "ola"]);
